...
folder_path = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))  # Get the absolute path to the parent directory
...
for filename in file_list:
    ...
    if os.path.isfile(current_file_path):
        ...
        if match:
            ...
            new_file_name = new_file_name.replace("-", "").replace(" ", "") + ".jpg"
